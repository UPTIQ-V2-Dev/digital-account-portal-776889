...
import productRoute from '../v1/product.route.ts';
...
describe('Product Routes', () => {
    ...
    describe('GET /v1/products', () => {
        ...
        it('should override isActive to true for public endpoint', async () => {
            mockProductService.getAllProducts.mockResolvedValue([mockProduct]);
    ...
    describe('GET /v1/products/:productId', () => {
        it('should return 200 and product data when active', async () => {
    ...
    describe('Error Handling', () => {
        ...
        it('should return proper error structure for not found products', async () => {
            mockProductService.getProductById.mockResolvedValue(null);

            const res = await request(app)
                .get('/v1/products/nonexistent-product')
                .expect(httpStatus.NOT_FOUND);
